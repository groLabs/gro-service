...
const { MESSAGE_TYPES, DISCORD_CHANNELS, sendMessageToChannel, } = require('../../common/discord/discordService').default;
...
async function getExposureStats(blockTag, systemStats) {
    ...
    const preCal = await getLatestSystemContract(ContractNames.insurance).contract.prepareCalculation(blockTag);
