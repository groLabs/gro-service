...
import { getAPY, getTVL, getSystem, getVaults, getReserves, getLifeguard, getLifeguardStables, getStrategies, getExposureStables, getExposureProtocols } from '../parser/groStatsParser';
